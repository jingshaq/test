...
// CMfcHelloWorldDlg 对话框



CMfcHelloWorldDlg::CMfcHelloWorldDlg(CWnd* pParent /*=NULL*/)
...
BEGIN_MESSAGE_MAP(CMfcHelloWorldDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CMfcHelloWorldDlg::OnBnClickedButton1)
END_MESSAGE_MAP()


// CMfcHelloWorldDlg 消息处理程序
...
{
	// TODO: 在此添加控件通知处理程序代码
	MessageBox(_T("这是测试按钮"), _T("提示"), MB_YESNO);
}
