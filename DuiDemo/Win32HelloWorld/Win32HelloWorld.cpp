// Win32HelloWorld.cpp : 定义应用程序的入口点。
//

#include "stdafx.h"
#include "Win32HelloWorld.h"
...
TCHAR g_szTitle[MAX_LOADSTRING] = TEXT("Message process测试");          // 窗口标题
TCHAR g_szWindowClass[MAX_LOADSTRING] = TEXT("Win32HelloWorld测试");    // 窗口类的名称
HWND g_hWnd;                                                            // 窗口句柄
bool g_bWhite = false;                                                  // 是否为白色背景


// 注册窗口类（初始化：HINSTANCE对象）
